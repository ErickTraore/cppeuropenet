...
run_staging() {
  ...
  local staging_specs="${STAGING_CYPRESS_SPEC:-cypress/e2e/new/new-0-start/004_servicesInventory.cy.js,cypress/e2e/new/new-0-start/006_initUsersE2E.cy.js,cypress/e2e/new/new-0-start/007_initUsersE2E_2.cy.js,cypress/e2e/new/new-0-start/007_servicesStatus.cy.js,cypress/e2e/new/new-0-start/009_loginFormE2E.cy.js,cypress/e2e/new/new-11/044_homePageVisitorFlow.cy.js}"
